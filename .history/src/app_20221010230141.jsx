...
function App() {
  ...
  onAdd = (name) => {
    ...
    fetch("https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResult=25&q="{name},"&key=AIzaSyAOYM6BsGM6PHnP_eKO7Cur7dBMG0u1ovU", requestOptions)
